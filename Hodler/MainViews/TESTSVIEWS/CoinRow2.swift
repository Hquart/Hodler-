...
struct CoinRow2: View {
    ...
    func progressViewColor(input: Double) -> Color {
            if input <= 25 {  return Color.green }
        if input <= 50 {  return Color.blue }
        if input <= 75 {  return Color.orange }
            return Color.red
        }
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
struct CoinRow2_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        Spacer(minLength: 350)
            CoinRow2(coin: coinData[0]).previewLayout(.sizeThatFits)
            Spacer(minLength: 200)
            CoinRow2(coin: coinData[1]).previewLayout(.sizeThatFits)
